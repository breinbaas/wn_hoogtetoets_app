...
class StartPcLayout extends StatefulWidget {
  final Future<List<String>> leveeList;

  StartPcLayout({this.leveeList});

  _StartPcLayoutState createState() => _StartPcLayoutState();
}

class _StartPcLayoutState extends State<StartPcLayout> {
  double _year = 2021;
        ...
        child: FractionallySizedBox(
          ...
          child: Row(
            children: [
              //Box for the image
              SizedBox(
                width: MediaQuery.of(context).size.width * (responsiveWidth / 2),
                      ...
                      Flexible(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 30),
                            Text("DISCLAIMER: De riscio's zijn alleen berekend op hoogte", style: TextStyle(fontSize: 18),)
                          ],
                        ),
                      ),
                    ],
                                      ...
                                      return Align(
                                        ...
                                        child: Material(
                                            child: Container(
                                                ...
                                                width: (MediaQuery.of(context).size.width * (responsiveWidth / 2) - 40) * responsiveWidth,
